  ...
  return (
    isVisible && (
      <>
                ...
                <thead>
                  <tr className="pt-[16px]">
                    <td className="p-2  text-center ">
                      <h3 className="border rounded-md p-2 bg-custom-gradient">
                        Horario
                      </h3>
                    </td>
                    <td className=" w-3/4 text-center">
                      <h3 className="border rounded-md p-2 mr-2 bg-custom-gradient">
                        Descripción
                      </h3>
                    </td>
                  </tr>
                  ...
                  {motivos.map((motivo, index) => (
                    <tr key={index} className="space-x-2">
                      <td className="p-2  text-center w-1/4">
                        <p className="border rounded-md p-2 bg-white">
                          {" "}
                          {motivo.time}
                        </p>
                      </td>
        ...
        {addModal && (
          <ModalAdd isVisible={addModal} setModalIsVisible={setAddModal} />
        )}
        {deletedReason && (
          <ModalCancel
